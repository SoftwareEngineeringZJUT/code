...
CREATE TABLE `admin`  (
  ...
  `account` varchar(256) CHARACTER SET utf8 COLLATE utf8_0900_ai_ci NOT NULL COMMENT '账号',
  `password` varchar(256) CHARACTER SET utf8 COLLATE utf8_0900_ai_ci NOT NULL COMMENT '密码',
  `real_name` varchar(256) CHARACTER SET utf8 COLLATE utf8_0900_ai_ci NOT NULL COMMENT '真实姓名',
...
) ENGINE = InnoDB AUTO_INCREMENT = 10 CHARACTER SET = utf8 COLLATE = utf8_0900_ai_ci COMMENT = '管理员' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `blacklist`  (
  `uid` varchar(256) CHARACTER SET utf8 COLLATE utf8_0900_ai_ci NOT NULL COMMENT '用户名',
  PRIMARY KEY (`uid`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_0900_ai_ci COMMENT = '黑名单' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `order`  (
  ...
  `+` varchar(255) CHARACTER SET utf8 COLLATE utf8_0900_ai_ci NULL DEFAULT NULL COMMENT '',
...
) ENGINE = InnoDB AUTO_INCREMENT = 221018020 CHARACTER SET = utf8 COLLATE = utf8_0900_ai_ci COMMENT = '订单表' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `product`  (
  ...
  `name` varchar(32) CHARACTER SET utf8 COLLATE utf8_0900_ai_ci NOT NULL DEFAULT '请输入商品名称' COMMENT '商品名称',
  ...
  `settlement_type` varchar(25) CHARACTER SET utf8 COLLATE utf8_0900_ai_ci NOT NULL DEFAULT '存款' COMMENT '结息方式',
  `onsale` int NOT NULL COMMENT '是否上线',
  `description` varchar(2000) CHARACTER SET utf8 COLLATE utf8_0900_ai_ci NOT NULL DEFAULT '关于商品的描述。。。' COMMENT '商品说明',
  `service_process` varchar(256) CHARACTER SET utf8 COLLATE utf8_0900_ai_ci NOT NULL COMMENT '原子服务流程',
...
) ENGINE = InnoDB AUTO_INCREMENT = 3 CHARACTER SET = utf8 COLLATE = utf8_0900_ai_ci COMMENT = '产品表' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `user`  (
  ...
  `password` varchar(256) CHARACTER SET utf8 COLLATE utf8_0900_ai_ci NOT NULL COMMENT '密码',
  `real_name` varchar(256) CHARACTER SET utf8 COLLATE utf8_0900_ai_ci NOT NULL COMMENT '真实姓名',
  `id_card` varchar(256) CHARACTER SET utf8 COLLATE utf8_0900_ai_ci NULL DEFAULT NULL COMMENT '身份证号',
  `address` varchar(256) CHARACTER SET utf8 COLLATE utf8_0900_ai_ci NOT NULL COMMENT '地址',
  `bank_card` varchar(25) CHARACTER SET utf8 COLLATE utf8_0900_ai_ci NOT NULL COMMENT '银行卡号',
  `phone` varchar(256) CHARACTER SET utf8 COLLATE utf8_0900_ai_ci NOT NULL COMMENT '手机号',
  `user_status` varchar(256) CHARACTER SET utf8 COLLATE utf8_0900_ai_ci NULL DEFAULT '0' COMMENT '用户状态',
  `balance` bigint NOT NULL DEFAULT 0 COMMENT '余额',
  `label` varchar(256) CHARACTER SET utf8 COLLATE utf8_0900_ai_ci NOT NULL COMMENT '用户标签',
  `gmt_create` datetime NOT NULL ON UPDATE CURRENT_TIMESTAMP COMMENT '创建时间',
  `gmt_update` datetime NOT NULL ON UPDATE CURRENT_TIMESTAMP COMMENT '修改时间',
  PRIMARY KEY (`uid`) USING BTREE,
  UNIQUE INDEX `acc`(`account`) USING BTREE COMMENT '唯一'
) ENGINE = InnoDB AUTO_INCREMENT = 41 CHARACTER SET = utf8 COLLATE = utf8_0900_ai_ci COMMENT = '用户表信息' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `whitelist`  (
  `uid` varchar(256) CHARACTER SET utf8 COLLATE utf8_0900_ai_ci NOT NULL COMMENT '用户名',
  PRIMARY KEY (`uid`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_0900_ai_ci COMMENT = '白名单' ROW_FORMAT = DYNAMIC;
